...
async function scrapeL1AlbertaStandings() {
  const leagueName = 'League1 Alberta';
  const url = 'https://league1alberta.com/competition/league1-mens/';
  ...
  try {
    ...
    return {
      ...
      source: "live_scrape",
      divisions: [{
        name: "2025 Men ALberta Division",
        teams
      }]
    };
  } catch (err) {
    console.error('❌ League1 Alberta scrape failed: ${err.message}');
...
module.exports = scrapeL1AlbertaStandings;