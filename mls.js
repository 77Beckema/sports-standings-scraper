...
async function scrapeMLSstandings() {
  ...
  await page.goto("https://www.mlssoccer.com/standings/2025/supporters-shield#season=MLS-SEA-0001K9&live=false", {
  ...
  console.log("✅ MLS scrape returned", eastern.length + western.length, "teams");
  return result;
}
