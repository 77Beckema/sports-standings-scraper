...
async function scrapeUSL1Standings() {
  const leagueName = "USL Championship";
  const url = "https://www.uslleagueone.com/league-standings";
  let browser;
  ...
  try {
    ...
    console.log(`✅ USL l1 scrape returned ${allTeams.length} teams total`);
    await browser.close();
    return result;
    ...
    console.error("❌ USL l1 standings scrape failed:", err.message);
...
module.exports = scrapeUSL1Standings;
