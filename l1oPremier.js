...
async function scrapeL1OPremierStandings() {
  const leagueName = 'League1 Ontario Premier';
  const url = 'https://www.league1ontario.com/competition/league-1-mens-premier/';
  ...
  try {
    ...
    return {
      ...
      source: "live_scrape",
      divisions: [{
        name: "2025 Men Premier Division",
        teams
      }]
    };
  } catch (err) {
...
module.exports = scrapeL1OPremierStandings;
