...
async function scrapeUSportsStandings() {
  const url = 'https://en.usports.ca/sports/msoc/2024-25/standings';
  const leagueName = 'U SPORTS';
...
module.exports = scrapeUSportsStandings;